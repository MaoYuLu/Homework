...
public class Main {
    ...
    public static void findByNum() {
        ...
        while (true) {
            ...
            if (dao.findByNum(input) != null) {
                ...
                System.out.println("查询失败,不存在该学生");
                return;
            }
        }
    }
    ...
    public static void delByNum() {
        ...
        while (true) {
            ...
            if (dao.delByNum(input)) {
                ...
                System.out.print("删除失败,不存在该学生,请重新输入要删除的学生?");
            }
        }
    }
    /**
    ...
    public static void delAll() {
        while (true) {
            System.out.print("是否要删除所有学生信?确定请输入YES,否请输入NO?");
            String input = getInput();
